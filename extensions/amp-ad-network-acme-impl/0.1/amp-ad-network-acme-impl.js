 ...
 * @private
 */
const ACME_BASE_URL = 'http://www.acme.com/_a4a';
 ...
 */
export class AmpAdNetworkAcmeImpl extends AmpA4A {
  ...
  getAdUrl() {
    ...
    return ACME_BASE_URL + encodeURI(this.element.getAttribute('src'));
  }
...
AMP.registerElement('amp-ad-network-acme-impl',
  AmpAdNetworkAcmeImpl);
